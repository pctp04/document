# 13.0 Student Login Screen Fields

| No. | FIELD NAME | DATA TYPE | LENGTH | FIELD TYPE | REQUIRED | DEFAULT VALUE | DISPLAY FORMAT | EXAMPLE | REMARKS |
|-----|------------|-----------|--------|------------|----------|--------------|---------------|---------|---------|
| | | MIN | MAX | | | | | | |
| 1 | Username | string | 1 | 100 | Text Input | Yes | - | - | `student01` | Username field with user icon. Accepts alphanumeric characters and underscores. Auto-focus on page load. |
...
| 4 | Sign In Button | - | - | - | Button | - | - | - | - | Submit button to authenticate student. Shows loading state during submission. |
