# 7.0 Teacher Login Screen Fields

| No. | FIELD NAME | DATA TYPE | LENGTH | FIELD TYPE | REQUIRED | DEFAULT VALUE | DISPLAY FORMAT | EXAMPLE | REMARKS |
|-----|------------|-----------|--------|------------|----------|--------------|---------------|---------|---------|
| | | MIN | MAX | | | | | | |
| 1 | Username | string | 1 | 100 | Text Input | Yes | - | - | `teacher01` | Username field with user icon. Accepts alphanumeric characters and underscores. Auto-focus on page load. |
...
| 4 | Sign In Button | - | - | - | Button | - | - | - | - | Submit button to authenticate teacher. Shows loading state during submission. |
