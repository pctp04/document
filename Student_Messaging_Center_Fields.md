# 18.0 Messaging Center (Student) Screen Fields

| No. | FIELD NAME | DATA TYPE | LENGTH | FIELD TYPE | REQUIRED | DEFAULT VALUE | DISPLAY FORMAT | EXAMPLE | REMARKS |
|-----|------------|-----------|--------|------------|----------|--------------|---------------|---------|---------|
| | | MIN | MAX | | | | | | |
| 1 | Message Type Filter | string | - | - | Dropdown | No | All Messages | - | `Received` | Filter by message type. Options: All Messages, Sent, Received. |
| 2 | Sender Filter | string | - | - | Dropdown | No | All Senders | - | `Teachers` | Filter by sender type. Options: All Senders, Teachers, Students, System. |
...
| 5 | Recipient Type | string | - | - | Radio/Dropdown | Yes | - | - | `Teacher` | Select recipient type: Teacher, Student, All Students in Curriculum. |
| 6 | Recipient Selection | integer | - | - | Dropdown/Multi-select | Yes | - | - | `1` | Select specific recipient (teacher or student). |
| 7 | Curriculum Selection | integer | - | - | Dropdown | No | - | - | `1` | Select curriculum to message all students (if applicable). |
| 8 | Message Subject | string | 1 | 200 | Text Input | Yes | - | - | `Question about Assignment` | Subject line of the message. |
| 9 | Message Body | string | 1 | 2000 | Textarea | Yes | - | - | `I have a question about...` | Main content of the message. Rich text editor support. |
| 10 | Attachments | file | - | - | File Upload | No | - | - | `document.pdf` | Attach files to message. Multiple files supported. |
| 11 | Send Button | - | - | - | Button | - | - | - | - | Send message to selected recipient. |
...
| 15 | Message Subject (Display) | string | - | - | Display | - | - | - | `Question about Assignment` | Subject of message in inbox. |
| 16 | Message Preview | string | - | - | Display | - | - | - | `I have a question...` | Truncated preview of message content. |
